...
<body class="p-3 mb-2 bg-light">
    ...
    <?php include("menu.php")?>
        <div class="row">
            <div class="col-xs-2 col-sm-2 col-md-1" id="ayuda">
                <button onclick="ayuda1()" type="button">
                    <img src="imagenes/ayuda.jpg" height="80" width="80" />
                </button>
            </div>
            ...
            <div class="col-sm-12 col-md-5" id="divres">
                <div class="row bg-white">
                    <form action="verificar.php" method="POST" id="frmIngreso">
                        <br>
                        <div class="mb-3">
                            <label for="txttel" class="form-label">Numero de Telefono</label>
                ...
                <p class="fw-lighter fs-6 text-wrap text-center">Crea tu cuenta y asi estaras mas cerca de tu familia.
                </p>
            </div>
        </div>
        <?php include("pie.php")?>
