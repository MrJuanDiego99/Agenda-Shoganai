            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item display-6" href="upload.php">Agreagar Foto Perfil</a></li>
                        <li><a class="dropdown-item display-6" href="info_usuario1.php">Informacion Usuario</a></li>
